...
class FirebasemlEmpty extends \Google\Model
{
}
...
class_alias(FirebasemlEmpty::class, 'Google_Service_FirebaseML_FirebasemlEmpty');
class_alias(ListOperationsResponse::class, 'Google_Service_FirebaseML_ListOperationsResponse');
class_alias(ModelOperationMetadata::class, 'Google_Service_FirebaseML_ModelOperationMetadata');
class_alias(Operation::class, 'Google_Service_FirebaseML_Operation');
class_alias(Status::class, 'Google_Service_FirebaseML_Status');
