...
class CloudDeploy extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->projects_locations_customTargetTypes = new CloudDeploy\Resource\ProjectsLocationsCustomTargetTypes(
        $this,
        $this->serviceName,
        'customTargetTypes',
        [
    ...
    $this->projects_locations_deliveryPipelines_automationRuns = new CloudDeploy\Resource\ProjectsLocationsDeliveryPipelinesAutomationRuns(
        $this,
        $this->serviceName,
        'automationRuns',
        [
    ...
    $this->projects_locations_deliveryPipelines_automations = new CloudDeploy\Resource\ProjectsLocationsDeliveryPipelinesAutomations(
        $this,
        $this->serviceName,
        'automations',
        [
