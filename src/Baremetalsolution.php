...
class Baremetalsolution extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->projects_locations = new Baremetalsolution\Resource\ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->projects_locations_networks = new Baremetalsolution\Resource\ProjectsLocationsNetworks(
        $this,
        $this->serviceName,
        'networks',
        [
    ...
    $this->projects_locations_provisioningQuotas = new Baremetalsolution\Resource\ProjectsLocationsProvisioningQuotas(
        $this,
        $this->serviceName,
        'provisioningQuotas',
        [
    ...
    $this->projects_locations_volumes_luns = new Baremetalsolution\Resource\ProjectsLocationsVolumesLuns(
        $this,
        $this->serviceName,
        'luns',
        [
...
class_alias(Baremetalsolution::class, 'Google_Service_Baremetalsolution');
