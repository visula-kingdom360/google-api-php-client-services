 ...
 * <a href="https://cloud.google.com/contact-center/insights/docs" target="_blank">Documentation</a>
 * </p>
 *
 * @author Google, Inc.
 */
class Contactcenterinsights extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->version = 'v1';
    $this->serviceName = 'contactcenterinsights';

    $this->projects_locations = new Contactcenterinsights\Resource\ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->projects_locations_conversations_analyses = new Contactcenterinsights\Resource\ProjectsLocationsConversationsAnalyses(
        $this,
        $this->serviceName,
        'analyses',
        [
    ...
    $this->projects_locations_insightsdata = new Contactcenterinsights\Resource\ProjectsLocationsInsightsdata(
        $this,
        $this->serviceName,
        'insightsdata',
        [
    ...
    $this->projects_locations_issueModels = new Contactcenterinsights\Resource\ProjectsLocationsIssueModels(
        $this,
        $this->serviceName,
        'issueModels',
        [
    ...
    $this->projects_locations_issueModels_issues = new Contactcenterinsights\Resource\ProjectsLocationsIssueModelsIssues(
        $this,
        $this->serviceName,
        'issues',
        [
    ...
    $this->projects_locations_operations = new Contactcenterinsights\Resource\ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        [
    ...
    $this->projects_locations_phraseMatchers = new Contactcenterinsights\Resource\ProjectsLocationsPhraseMatchers(
        $this,
        $this->serviceName,
        'phraseMatchers',
        [
    ...
    $this->projects_locations_views = new Contactcenterinsights\Resource\ProjectsLocationsViews(
        $this,
        $this->serviceName,
        'views',
        [
...
class_alias(Contactcenterinsights::class, 'Google_Service_Contactcenterinsights');
