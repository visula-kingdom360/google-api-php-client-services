...
class VMMigrationService extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->version = 'v1';
    $this->serviceName = 'vmmigration';

    $this->projects_locations = new VMMigrationService\Resource\ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->projects_locations_groups = new VMMigrationService\Resource\ProjectsLocationsGroups(
        $this,
        $this->serviceName,
        'groups',
        [
    ...
    $this->projects_locations_operations = new VMMigrationService\Resource\ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        [
    ...
    $this->projects_locations_sources = new VMMigrationService\Resource\ProjectsLocationsSources(
        $this,
        $this->serviceName,
        'sources',
        [
    ...
    $this->projects_locations_sources_datacenterConnectors = new VMMigrationService\Resource\ProjectsLocationsSourcesDatacenterConnectors(
        $this,
        $this->serviceName,
    ...
    $this->projects_locations_sources_migratingVms_cloneJobs = new VMMigrationService\Resource\ProjectsLocationsSourcesMigratingVmsCloneJobs(
        $this,
        $this->serviceName,
        'cloneJobs',
        [
    ...
    $this->projects_locations_sources_migratingVms_cutoverJobs = new VMMigrationService\Resource\ProjectsLocationsSourcesMigratingVmsCutoverJobs(
        $this,
        $this->serviceName,
        'cutoverJobs',
        [
    ...
    $this->projects_locations_sources_utilizationReports = new VMMigrationService\Resource\ProjectsLocationsSourcesUtilizationReports(
        $this,
        $this->serviceName,
        'utilizationReports',
        [
    ...
    $this->projects_locations_targetProjects = new VMMigrationService\Resource\ProjectsLocationsTargetProjects(
        $this,
        $this->serviceName,
        'targetProjects',
        [
...
class_alias(VMMigrationService::class, 'Google_Service_VMMigrationService');
