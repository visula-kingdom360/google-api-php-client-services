 ...
 * <a href="https://cloud.google.com/bigquery/docs/analytics-hub-introduction" target="_blank">Documentation</a>
 * </p>
 *
 * @author Google, Inc.
 */
class AnalyticsHub extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->projects_locations_dataExchanges = new AnalyticsHub\Resource\ProjectsLocationsDataExchanges(
        $this,
        $this->serviceName,
        'dataExchanges',
        [
    ...
    $this->projects_locations_dataExchanges_listings = new AnalyticsHub\Resource\ProjectsLocationsDataExchangesListings(
        $this,
        $this->serviceName,
        'listings',
        [
...
class_alias(AnalyticsHub::class, 'Google_Service_AnalyticsHub');
