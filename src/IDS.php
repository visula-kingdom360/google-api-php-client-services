 ...
 * When you use this product, your organization name and consumption levels will
 * be shared with Palo Alto Networks.</p>
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class IDS extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->projects_locations = new IDS\Resource\ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->projects_locations_endpoints = new IDS\Resource\ProjectsLocationsEndpoints(
        $this,
        $this->serviceName,
        'endpoints',
        [
    ...
    $this->projects_locations_operations = new IDS\Resource\ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        [
...
class_alias(IDS::class, 'Google_Service_IDS');
