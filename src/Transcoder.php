 ...
 * <a href="https://cloud.google.com/transcoder/docs/" target="_blank">Documentation</a>
 * </p>
 *
 * @author Google, Inc.
 */
class Transcoder extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->projects_locations_jobs = new Transcoder\Resource\ProjectsLocationsJobs(
        $this,
        $this->serviceName,
        'jobs',
        [
...
class_alias(Transcoder::class, 'Google_Service_Transcoder');
