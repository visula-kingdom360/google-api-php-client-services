 ...
 * <a href="https://cloud.google.com/support/docs/apis" target="_blank">Documentation</a>
 * </p>
 *
 * @author Google, Inc.
 */
class CloudSupport extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->cases = new CloudSupport\Resource\Cases(
        $this,
        $this->serviceName,
        'cases',
        [
    ...
    $this->cases_attachments = new CloudSupport\Resource\CasesAttachments(
        $this,
        $this->serviceName,
        'attachments',
        [
    ...
    $this->media = new CloudSupport\Resource\Media(
        $this,
        $this->serviceName,
        'media',
        [
...
class_alias(CloudSupport::class, 'Google_Service_CloudSupport');
