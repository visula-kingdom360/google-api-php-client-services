...
class Libraryagent extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->shelves = new Libraryagent\Resource\Shelves(
        $this,
        $this->serviceName,
        'shelves',
        [
    ...
    $this->shelves_books = new Libraryagent\Resource\ShelvesBooks(
        $this,
        $this->serviceName,
        'books',
        [
...
class_alias(Libraryagent::class, 'Google_Service_Libraryagent');
