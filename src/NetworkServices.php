...
class NetworkServices extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->version = 'v1';
    $this->serviceName = 'networkservices';

    $this->projects_locations = new NetworkServices\Resource\ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->projects_locations_edgeCacheKeysets = new NetworkServices\Resource\ProjectsLocationsEdgeCacheKeysets(
        $this,
        $this->serviceName,
        'edgeCacheKeysets',
        [
    ...
    $this->projects_locations_edgeCacheOrigins = new NetworkServices\Resource\ProjectsLocationsEdgeCacheOrigins(
        $this,
        $this->serviceName,
        'edgeCacheOrigins',
        [
    ...
    $this->projects_locations_edgeCacheServices = new NetworkServices\Resource\ProjectsLocationsEdgeCacheServices(
        $this,
        $this->serviceName,
        'edgeCacheServices',
        [
    ...
    $this->projects_locations_endpointPolicies = new NetworkServices\Resource\ProjectsLocationsEndpointPolicies(
        $this,
        $this->serviceName,
        'endpointPolicies',
        [
    ...
    $this->projects_locations_gateways = new NetworkServices\Resource\ProjectsLocationsGateways(
        $this,
        $this->serviceName,
        'gateways',
        [
    ...
    $this->projects_locations_grpcRoutes = new NetworkServices\Resource\ProjectsLocationsGrpcRoutes(
        $this,
        $this->serviceName,
        'grpcRoutes',
        [
    ...
    $this->projects_locations_httpRoutes = new NetworkServices\Resource\ProjectsLocationsHttpRoutes(
        $this,
        $this->serviceName,
        'httpRoutes',
        [
    ...
    $this->projects_locations_lbTrafficExtensions = new NetworkServices\Resource\ProjectsLocationsLbTrafficExtensions(
        $this,
        $this->serviceName,
        'lbTrafficExtensions',
        [
    ...
    $this->projects_locations_meshes = new NetworkServices\Resource\ProjectsLocationsMeshes(
        $this,
        $this->serviceName,
        'meshes',
        [
    ...
    $this->projects_locations_serviceLbPolicies = new NetworkServices\Resource\ProjectsLocationsServiceLbPolicies(
        $this,
        $this->serviceName,
        'serviceLbPolicies',
        [
    ...
    $this->projects_locations_tcpRoutes = new NetworkServices\Resource\ProjectsLocationsTcpRoutes(
        $this,
        $this->serviceName,
        'tcpRoutes',
        [
    ...
    $this->projects_locations_tlsRoutes = new NetworkServices\Resource\ProjectsLocationsTlsRoutes(
        $this,
        $this->serviceName,
        'tlsRoutes',
        [
...
class_alias(NetworkServices::class, 'Google_Service_NetworkServices');
